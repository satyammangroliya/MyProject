        ...
        <table class="table"> 
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('customer.delete',['id'=> $customer->customer_id])); ?>"><button class="btn btn-danger">Trash</button></a>
                        <a href="<?php echo e(route('customer.edit',['id'=> $customer->customer_id])); ?>"><button class="btn btn-primary">Edit</button></a>
                    </td>
                </tr>
...
</html><?php /**PATH C:\xampp\htdocs\Learning\resources\views/customer-view.blade.php ENDPATH**/ ?>